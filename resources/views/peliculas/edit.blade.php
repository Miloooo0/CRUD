    ...
    <div>
        ...
        <form action="{{ route('peliculas.update', $pelicula->id) }}" method="POST">
            ...
            <div>
                ...
                <input type="text" id="nombre" name="nombre" value="{{ old('nombre', $pelicula->nombre) }}" required>
            </div>
            ...
            <div>
                ...
                <input type="date" id="fecha" name="fecha" value="{{ old('fecha', $pelicula->fecha) }}" required>
            </div>

            <div>
                <label for="duracion">Duración</label>
                <input type="duracion" id="duracion" name="duracion" value="{{ old('duracion', $pelicula->duracion) }}" required>
            </div>

            <div>
                <label for="genero">Género</label>
                <input type="genero" id="genero" name="genero" value="{{ old('genero', $pelicula->genero) }}" required>
            </div>


            <div>
                <label for="idioma">País</label>
                <input type="text" id="idioma" name="idioma" value="{{ old('idioma', $pelicula->idioma) }}" require>
            </div>
